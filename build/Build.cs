...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-ado-service-connection";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — orchestrator integration belongs in the consumer's pipeline.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.AdoServiceConnection.V1.Tests" / "Tamp.AdoServiceConnection.V1.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.AdoServiceConnection.V1" / "Tamp.AdoServiceConnection.V1.csproj");
